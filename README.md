...
#### Collaboration Service -- Full Interaction Sequence

This single diagram traces every interaction the Collaboration Service has -- from match notification through session creation, real-time coding, code execution, attempt recording, and AI hints -- showing the exact endpoints, queue names, and Socket.IO events involved.

```
 Matching      Collab         User         Question      RabbitMQ     Execution      Attempt       Redis          Gemini
  Service      Service       Service       Service       (:5672)      Service       Service                     2.5 Flash
  (:3002)      (:3003)       (:3001)       (:3005)                    (:3006)       (:3004)
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 1. MATCH FOUND ==========================================================================+===============+===
     |             |             |             |             |             |             |             |             |
  emit match_preparing to BOTH users (Socket.IO)             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ...
  ===+== 2. SESSION CREATION ======================================================================+===============+===
     |             |             |             |             |             |             |             |             |
     |             | consume from collab_create_req_queue    |             |             |             |             |
     |             |<----------------------------------------+             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             | POST /users/internal/validation/batch   |             |             |             |             |
     |             +------------>|             |             |             |             |             |             |
     |             | allValid: true/false      |             |             |             |             |             |
     |             |<------------+             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     ...
     |             |<--------------------------+             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             | store session + OT document + idempotency keys        |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             +---------------------------------------->| collab_create_res_queue   |             |             |
     |             |             |             |             |             |             |             |             |
     |  consume from collab_create_res_queue   |             |             |             |             |             |
     |<------------------------------------------------------+             |             |             |             |
     |             |             |             |             |             |             |             |             |
  emit match_success to BOTH users (Socket.IO) |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 3. SOCKET AUTH (every connection to /sessions/socket.io/) ====+===============+===============+===========+===
     |             |             |             |             |             |             |             |             |
     |             | GET /users/internal/authz/context       |             |             |             |             |
     |             +------------>|             |             |             |             |             |             |
     |             | clerkUserId, role, status |             |             |             |             |             |
     ...
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 4. SESSION JOIN (client emits session:join) ==================+===============+===============+===========+===
     |             |             |             |             |             |             |             |             |
     |             | load session, OT document, presence, hints            |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             | session state             |             |             |             |             |             |
     |             |<----------------------------------------------------------------------------------+             |
     |             |             |             |             |             |             |             |             |
     |             | update presence + register socket       |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             | emit user:joined to room  |             |             |             |             |             |
     |             | emit presence:updated to room           |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 5. REAL-TIME CODING (client emits code:change) ===============+===============+===============+===========+===
     |             |             |             |             |             |             |             |             |
     |             | Lua CAS: apply OT ops + increment revision            |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             | new revision|             |             |             |             |             |             |
     |             |<----------------------------------------------------------------------------------+             |
     |             |             |             |             |             |             |             |             |
     ...
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             | emit code:change to room (excl. sender) |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 6. CODE EXECUTION (client emits code:run or code:submit) =====+===============+===============+===========+===
     |             |             |             |             |             |             |             |             |
     |             | emit code:running to room |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             | read current code + test cases          |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             | code + test cases         |             |             |             |             |             |
     |             |<----------------------------------------------------------------------------------+             |
     |             |             |             |             |             |             |             |             |
     |             | set execution pending lock (65s TTL)    |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             +---------------------------------------->| exec_req_queue            |             |             |
     |             |             |             |             |             |             |             |             |
     |             |             |             |             | consume     |             |             |             |
     |             |             |             |             +------------>|             |             |             |
     |             |             |             |             | Piston sandbox executes code            |             |
     |             |             |             |             | test results|             |             |             |
     |             |             |             |             |<------------+             |             |             |
     |             |             |             |             | publish to exec_res_queue |             |             |
     |             |             |             |             |             |             |             |             |
     |             | consume from exec_res_queue             |             |             |             |             |
     |             |<----------------------------------------+             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             | clear pending lock + store output       |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             | emit output:updated to room             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 7. ON SUBMIT ONLY (record attempt, update proficiency score) =+===============+===============+===========+===
     |             |             |             |             |             |             |             |             |
     |             | POST /attempts            |             |             |             |             |             |
     |             +-------------------------------------------------------------------->|             |             |
     |             |             |             |             |             |             |             |             |
     ...
     |             |             |<------------------------------------------------------+             |             |
     |             |             +------------------------------------------------------>|             |             |
     |             | attempt + scoreUpdates    |             |             |             |             |             |
     |             |<--------------------------------------------------------------------+             |             |
     |             |             |             |             |             |             |             |             |
     |             | emit submission:complete to SUBMITTER only            |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 8. AI HINTS (client emits hint:request, max 2/user) ==========+===============+===============+===========+===
     |             |             |             |             |             |             |             |             |
     ...
     |             |<----------------------------------------------------------------------------------+             |
     |             |             |             |             |             |             |             |             |
     |             | read current code + previous hints      |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             | code + hints|             |             |             |             |             |             |
     |             |<----------------------------------------------------------------------------------+             |
     |             |             |             |             |             |             |             |             |
     ...
     |             +------------------------------------------------------------------------------------------------>|
     |             | 2-3 sentence conceptual hint            |             |             |             |             |
     |             |<------------------------------------------------------------------------------------------------+
     |             |             |             |             |             |             |             |             |
     |             | store hint in Redis       |             |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             | emit hint:updated to room |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
  ===+== 9. SESSION END (client emits session:leave, or inactivity/TTL expiry) +=======+===============+===========+===
     |             |             |             |             |             |             |             |             |
     |             | mark user as left in presence           |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             | emit user:left to room    |             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
     |             | if both LEFT or DISCONNECTED:           |             |             |             |             |
     |             |   clean up all session data             |             |             |             |             |
     |             +---------------------------------------------------------------------------------->|             |
     |             |             |             |             |             |             |             |             |
     |             | emit session:ended to room|             |             |             |             |             |
     |             |             |             |             |             |             |             |             |
```

**Flow walkthrough:**

1. **Match Found** -- Matching Service's Lua `FIND_MATCH` script pairs two users. It emits `match_preparing` to both clients via Socket.IO, then publishes the match details to `collab_create_req_queue` in RabbitMQ.

2. **Session Creation** -- Collab Service consumes the message and validates both users via `POST /users/internal/validation/batch`. It then calls Question Service twice: `POST /internal/select` to pick a question matching the topic, difficulty, and users, and `POST /internal/get` to fetch the full question details (title, test cases, function signature). It stores the session, OT document, and idempotency keys in Redis, then publishes the result to `collab_create_res_queue`. Matching Service consumes this and emits `match_success` to both clients with the `collaborationId`.

3. **Socket Auth** -- When a client connects to `/sessions/socket.io/`, Collab Service verifies their JWT by calling `GET /users/internal/authz/context` on User Service, which returns the `clerkUserId`, role, and account status. On success it emits `connection:ready`.

4. **Session Join** -- The client emits `session:join`. Collab Service loads the full session state from Redis (session hash, OT document, revision, presence, previous hints), updates presence to mark the user as connected, registers the socket, then emits `user:joined` and `presence:updated` to the room.

5. **Real-Time Coding** -- On every `code:change` event, a Redis Lua CAS script atomically applies the OT operations and increments the revision. If the client's revision is behind, the server fetches the op history, transforms the operations, and retries. The activity timestamp is updated, and the change is broadcast to the room excluding the sender.

6. **Code Execution** -- When a client emits `code:run` or `code:submit`, Collab Service emits `code:running` to the room, reads the current code and test cases from Redis, sets a 65-second pending lock, and publishes to `exec_req_queue`. Execution Service consumes the message, runs the code in a Piston sandbox, and publishes the results to `exec_res_queue`. Collab Service consumes the response, clears the pending lock, stores the output in Redis, and emits `output:updated` to the room.

7. **On Submit Only** -- After execution results arrive for a `code:submit`, Collab Service calls `POST /attempts` on Attempt Service with the user's results. Attempt Service records the attempt, then calls `POST /users/internal/deltas` on User Service to update the proficiency score. The response (attempt record + score updates) flows back to Collab Service, which emits `submission:complete` to the submitter only.

8. **AI Hints** -- When a client emits `hint:request`, Collab Service increments the per-user hint counter in Redis and rejects if the count exceeds 2. It reads the current code and any previous hints from Redis, then calls `POST /v1beta/models/gemini-2.5-flash:generateContent` for a 2-3 sentence conceptual hint. The hint is stored in Redis and broadcast to the room via `hint:updated`.

9. **Session End** -- On `session:leave` (or inactivity/TTL expiry), Collab Service marks the user as left in the presence hash and emits `user:left`. When both users have left or disconnected, it cleans up all session data from Redis (session, OT document, presence, output, hints) and emits `session:ended` with the reason.
